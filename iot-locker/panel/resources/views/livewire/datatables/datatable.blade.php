<div>
    ...
    <div class=" position-relative">
        <div class="d-flex justify-content-between align-items-center mb-1">
            <div class="h-10 d-flex align-items-center">
                ...
                <div class="w-96 d-flex rounded-lg shadow-sm">
                    <div class="position-relative flex-grow-1 focus-within:z-10">
                        <div class="position-absolute d-flex align-items-center">
                            <svg class="h-5 w-5 text-light" viewBox="0 0 20 20" stroke="currentColor" fill="none">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
                        </div>
                        <input wire:model.debounce.500ms="search" class=" w-100 pl-3 py-3 text-small lead d-block rounded-2 border-light shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 focus:outline-none" placeholder="{{__('Search in')}} {{ $this->searchableColumns()->map->label->join(', ') }}" type="text" />
            ...
            <div class="d-flex flex-wrap align-items-center gap-1">
                ...
                @if($this->activeFilters)
                <button wire:click="clearAllFilters" class="d-flex align-items-center gap-2 px-3 border border-red-400 rounded-md bg-white text-red-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-red-200 focus:outline-none"><span>{{ __('Reset') }}</span>
        ...
        <div wire:loading.class="opacity-50" class="rounded-lg @unless($complex || $this->hidePagination) rounded-b-none @endunless shadow-lg bg-white max-w-screen overflow-x-scroll border-4 @if($this->activeFilters) border-blue-500 @else border-transparent @endif @if($complex) rounded-b-none border-b-0 @endif">
            <div>
                <div class=" table table-striped align-middle min-w-full">
