                ...
                <div class="card-header bg-light">
                    <div class="row">
                        <div class="col-md-6 col-6">
                            <div class="filter">
                                <select name="" id="" class=" form-select" wire:model="deliveryManOrderBy">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" wire:click="agentDeleteId({{ $data->id }})"
                    ...
                    <form wire:submit.prevent="updateDeliveryMan" method="POST">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input name='user_name' type="text" class="disabled form-control" id="user_name"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input name='user_full_name' type="text" class=" disabled form-control" id="user_full_name"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="agentDelete()" class="btn btn-danger close-modal"
