                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="row justify-content-md-center">
                                            <div class="col-sm-6">
                                                <h4>Add Single Box</h4>
                                            </div>
                                            <div class="col-sm-6" style="text-align:right">
                                                <a href="{{ route('locker-box.create-multiple') }}" class="btn win7-btn btn-secondary waves-effect waves-light"><i class='fe-plus me-1'></i>Add Multiple Box</a>
                                            </div>
                                        </div>
                                        <hr class="my-2" />
                                        <div class="row justify-content-md-center">
                                            <div class="col-md-8 mb-2">
                                                <form method="POST" action="{{ route('locker-box.store') }}">
                                                    @csrf
                                                    <div class="mb-3">
                                                        <label for="box_no" class="form-label">Box
                                                            Number</label>

                                                        <div class="input-group mb-2">
                                                            <div class="input-group-text">Box-</div>
                                                            <input class="form-control" type="text" id="box_no" name="box_no" placeholder="Enter box number" onfocus="myKeyboard(this)" autocomplete="off">
                                                        </div>

                                                    </div>
                                                    <div class="m-3">
                                                        <span class="p-2">
                                                            <input class="form-check-input" type="radio" name="boxsize" id="boxsizesamll" value="small">
                                                            <label class="form-check-label" for="boxsizesamll">Samll</label>
                                                        </span>
                                                        <span class="p-2">
                                                            <input class="form-check-input" type="radio" name="boxsize" id="boxsizemedium" value="medium">
                                                            <label class="form-check-label" for="boxsizemedium">Medium</label>
                                                        </span>
                                                        <span class="p-2">
                                                            <input class="form-check-input" type="radio" name="boxsize" id="boxsizelarge" value="large">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="form-check form-switch my-2">
                            ...
                            <label class="form-check-label" for="enable_add_box_mode">Enable Add Box
                                Mode</label>
                        </div>
                    </div>
                </div>
